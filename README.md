...
- **include/diagnostics.h** - Interfejs publiczny do generowania raportu diagnostycznego i deklaracje funkcji systemowych
- **src/diagnostics.cpp** - Implementacja funkcji systemowych
